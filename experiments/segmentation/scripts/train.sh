...
# test [single-scale]
CUDA_VISIBLE_DEVICES=1 python -m experiments.segmentation.test --dataset custom \
    --model deeplab --jpu JPU --aux --backbone resnet50 --resume runs/custom/deeplab/deeplab_res50_custom/checkpoint.pth  \
